...
class SegmentationTask(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optimizer = torch.optim.AdamW(
            ...
            weight_decay=self.config['hyperparams']['optim_weight_decay'],
            betas=tuple(self.config['hyperparams']['optim_betas']),
        )

        scheduler = None
        scheduler_config = {}

        if self.config['hyperparams']['scheduler'] == "reduce_on_plateau":
        ...
        elif self.config['hyperparams']['scheduler'] == "one_cycle_lr":
