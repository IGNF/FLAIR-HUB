...
from flair_inc.dataloader import flair_dataset
from flair_inc.utils.utils_data import pad_collate_flair
...
class FlairDataModule(LightningDataModule):
    ...
    def _create_flair_dataset(self, dict_paths, use_augmentations):
        """
    ...
    def _create_dataloader(self, dataset, batch_size, shuffle, drop_last):
        """
